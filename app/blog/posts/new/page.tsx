...
export default function PostsNew() {
    ...
    return (
        <div className="m-auto w-full md:w-1/2">
            ...
            <input type="text" className="w-full bg-white dark:bg-neutral-800 dark:text-neutral-400 rounded p-2 border mt-4" placeholder="Post Title" onChange={titleChanged}/>
            <div className=" mt-4">
                <Editor editorChanged={contentChanged}/>
            </div>
            <input type="text" className="w-full bg-white dark:bg-neutral-800 dark:text-neutral-400 rounded p-2 border mt-4" placeholder="Post Tags"/>
