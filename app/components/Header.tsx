...
export default function Header() {
    return (
        <header className="flex items-center justify-between px-32 bg-white py-4 shadow-2xl dark:bg-neutral-800 dark:text-neutral-400">
            ...
            <div>
                <ul className="flex items-center gap-12 laptop:flex-col uppercase text-xs text-right inline">
                    ...
                    <li>
                        <a className="dark:hover:text-sky-300 hover:text-sky-700" aria-label="linkedin" href="https://linkedin.com/in/CordMarston" target="_blank">
